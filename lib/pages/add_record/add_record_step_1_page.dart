...
import 'add_record_step_2_page.dart';

class AddRecordStep1Page extends StatefulWidget {
  const AddRecordStep1Page({super.key});

  @override
  State<StatefulWidget> createState() => _AddRecordStep1PageState();
}

class _AddRecordStep1PageState extends State<AddRecordStep1Page> {
          ...
          children: [
            ...
            Expanded(
                child: MyFilledButton(
                    ...
                    radius: 30,
                    onPressed: () {
                      Get.to(const AddRecordStep2Page());
                    }
                )
            )
          ]
